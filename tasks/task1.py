...
#
# testString = sp.getoutput('python tasks\\precondition_for_task1.py')
# print(testString)
...
# Replace all occurrences 'and' to '&'
print("Replace all occurrences 'and' to '&'")
print(testString.replace('and', '&'))
